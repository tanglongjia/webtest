...
public class ClassUtils {
	...
	public static void main (String[] args) {
		...
		// 获取属性
		Map<String, Class> map = getClassFields (classUtil.getClass(), true);
		for (Object key : map.keySet())	{
			System.out.println ("<field=" + key.toString() + "> <Type=" + map.get (key) + ">");
		}
		// 获取方法
		List<Method> methods = getClassMothds (classUtil.getClass(), false);
	...
	private static List<Method> getParentClassMothds (List<Method> list, Class clazz)	{
		...
		if (clazz.getSuperclass() == Object.class || clazz.getSuperclass() == null || clazz == Object.class)
		{
			return list;
		}
		getParentClassMothds (list, clazz.getSuperclass());
